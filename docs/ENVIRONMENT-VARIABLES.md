...
| `GLOBAL_DATAFEEDS_MAX_CALLS_PER_HOUR` | `0` | Client-side cap on GlobalDataFeeds calls per rolling hour (`0` = none). Set it to the account quota so a large catch-up stops itself |
