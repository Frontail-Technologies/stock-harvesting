  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 border-border bg-popover p-5 text-sm text-popover-foreground shadow-2xl duration-200 outline-none data-open:animate-in data-closed:animate-out",
