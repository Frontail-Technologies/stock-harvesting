...
const SEARCH_RESULTS = [
  {
    symbol: "RELIANCE",
    name: "Reliance Industries Limited Â· India",
    active: true,
  },
      ...
      <g>
        ...
        <g stroke="var(--landing-diagram-primary)" strokeWidth="1">
          <line
            ...
            x2={REVIEW_CROSSHAIR.x + 12}
            y2={REVIEW_CROSSHAIR.y}
          />
          <line
            x1={REVIEW_CROSSHAIR.x}
            y1={REVIEW_CROSSHAIR.y - 12}
            x2={REVIEW_CROSSHAIR.x}
            y2={REVIEW_CROSSHAIR.y + 12}
          />
        </g>
        <circle
          cx={REVIEW_CROSSHAIR.x}
          cy={REVIEW_CROSSHAIR.y}
          r="4"
          fill="var(--brand-gold)"
        />
      </g>
          ...
          {STEPS.map((step) => (
            ...
            >
              <Reveal className="landing-workflow-copy">
                ...
                <h3 className="landing-workflow-step-heading">
                  {step.heading}
                </h3>
              ...
              <Reveal
                from={step.reverse ? "left" : "right"}
                delay={0.1}
                className="landing-workflow-visual"
              >
                <div
                  className="landing-workflow-visual-grid"
                  aria-hidden="true"
                />
                <div
