...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 landing-hero-dot-grid" aria-hidden="true" />
      ...
      <div className="landing-container relative z-10 flex flex-col items-center text-center">
        <p className="landing-hero-eyebrow landing-reveal">Market Analysis &amp; Chart Workspace</p>
        ...
        >
          Understand a stock in seconds, <span className="landing-gradient-text">not hours.</span>
        </h1>
        ...
        >
          Surface relevant market context and review it in one focused workspace.
        </p>

        <div
          className="landing-reveal flex flex-wrap items-center justify-center gap-3 mt-7"
          style={{ "--landing-reveal-delay": "0.18s" } as CSSProperties}
        >
          <Link
            href="/login"
            id="hero-cta-primary"
